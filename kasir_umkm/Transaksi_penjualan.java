...
public class Transaksi_penjualan extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 160, 120, 40));
...
//        try {
    ...
    private MainFrame5 main5 = new MainFrame5();
...
//                popuppenjualan12 pwSalah = new popuppenjualan12();
//                pwSalah.setAlwaysOnTop(true);  // Agar popup berada di depan
//                pwSalah.setVisible(true);
//                return;
//            }
...
//            }
    ...
    public class MainFrame5 extends JFrame {
        ...
        public MainFrame5() {
            ...
            // Label dengan teks
            JLabel label = new JLabel("Apakah anda ingin mencetak struk", SwingConstants.CENTER);
            label.setForeground(Color.WHITE);
            label.setAlignmentX(Component.CENTER_ALIGNMENT); // Pusatkan label secara horizontal
            panel.add(Box.createVerticalStrut(35)); // Tambahkan jarak atas
            panel.add(label);
