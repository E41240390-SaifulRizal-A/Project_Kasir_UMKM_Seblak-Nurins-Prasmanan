 ...
 * @author THINKPAD
 */
public class Data_Gudang_kasir extends javax.swing.JFrame {
    ...
    private void tampilkanLaporanGudang() {
        try {
            ...
            tabelview.setModel(model); // Menampilkan data ke tabel
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
    ...
    private void initComponents() {
        ...
        tabelview.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Id Detail", "Id Produk", "Nama Produk", "Harga Beli", "Stok  Cadangan", "Tanggal Pemasukan", "Is Active"
            }
        ));
        tabelview.setRowHeight(30);
        jScrollPane1.setViewportView(tabelview);
        if (tabelview.getColumnModel().getColumnCount() > 0) {
            tabelview.getColumnModel().getColumn(0).setResizable(false);
            tabelview.getColumnModel().getColumn(3).setResizable(false);
        }

        jPanel1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(9, 17, 1060, 390));

        getContentPane().add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 200, 1080, 420));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Data_Gudang_kasir.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
